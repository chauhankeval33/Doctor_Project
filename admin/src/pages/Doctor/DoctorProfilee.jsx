...
const doctorProfile = () => {
  ...
  const { dToken, setProfileData, profileData, getProfileData,backendUrl } = useContext(doctor_context)
  const { currency,  } = useContext(app_context)
