...
const doctorDashboard = () => {
  ...
  const { dToken, setDashData, dashData, getDashData,completeAppointment,cancelAppointment } = useContext(doctor_context)
  const { currency,sloatDateFormat } = useContext(app_context)
        ...
        <div className='pt-4 border border-t-0'>
          {
            dashData.latestAppointments.map((item, index) => (
              <div className='flex items-center px-6 py-3 hover:bg-gray-100 gap-2 ' key={index}>
