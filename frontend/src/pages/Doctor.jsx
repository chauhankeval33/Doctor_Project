...
const Doctor = () => {
  ...
  return (
    <div>
      <p className='text-gray-600'> Browse through the doctor specilality.</p>
        ...
        <div className='w-full grid grid-cols-auto gap-4 gap-y-6'>
          {
            fileterDoc.map((item, index) => (
              <div onClick={() => navigate(`/appointment/${item._id}`)} className='border border-200 rounded-xl overflow-hidden cursor-pointer hover:translate-y-[-10px] transition-all duration-500' key={index}>
